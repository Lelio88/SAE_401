<?php require_once '../www/headerEmployee.inc.php'; ?>
        ...
        $(document).ready(function() {
            ...
            $("#AddCategoryForm").submit(function(e) {
                ...
                $.ajax({
                    ...
                    error: function(xhr, status, error) {
                        console.error("Erreur lors de l'ajout de la catégorie : ", xhr.responseText);
        ...
        <section>
            ...
            <div id="GestionMarques" style="display:none; width: 40%;">
                ...
                <div>
                    ...
                    <form action="" id="AddMarqueForm">
                        <input type="text" id="newMarqueName" placeholder="Name of the brand" required>
            ...
            <div id="GestionCategories" style="display:none;">
                ...
                <div>
                    ...
                    <form action="" id="AddCategoryForm">
                        <input type="text" id="newCategoryName" placeholder="Name of the category" required>
            ...
            <div id="GestionStocks" style="display:none;">
                <div>
                    ...
                    <div id="StockManagementForm" style="display:none;">
                        ...
                        <button type="submit" id="UpdateStockButton">Save changes</button>
                    </div>
                </div>
            </div>
            ...
            <div id="GestionMagasin" style="display:none; margin-top: 1em;">
                ...
                <form id="magasinForm">
                    ...
                    <label>E-mail : <input type="email" id="storeEmail" /></label><br />
                    <button type="submit">Save changes</button>
                </form>
            </div>
        </section>
